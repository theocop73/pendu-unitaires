...
describe('Hangman Game', () => {
  ...
  it('should fetch a random word', async () => {
    const mockAxiosGet = vi.fn().mockImplementation(async () => ({
      data: [{ name: 'testword', categorie: 'testcategory' }],
    }));
...
describe('Hangman Game', () => {
 ...
 // Injecte les lettres "t", "e", "s", "w", "o", "r", "d" comme entrées utilisateur
  });
  ...
  it('should display the uncovered word', () => {
    ...
    const uncoveredWord = initializeUncoveredWord('test');
